...
| AI Agent Book | active | PR #288 merged; PRs #322 and #323 are open and mergeable at their approved exact heads, with GitGuardian passed | Monitor review; obtain separate approval before any follow-up mutation |
...
- AI Agent Book PR #288 merged into `main` as `e9d1fe79`; PRs #322 and #323 are open at exact heads `c09e43e` and `7eae95e` after explicit approval.
...
1. Monitor AI Agent Book PRs #322 and #323 without mutating them.
