...
1. Extend context discovery with path-scoped nested `AGENTS.md` and compact report indexes.
2. Disable Karmada's canonical push URL before starting new contribution work.
3. Restore or re-onboard OpenSandbox before continuing candidate selection.
